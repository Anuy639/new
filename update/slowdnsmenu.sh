...
tput setaf 7 ; tput setab 4 ; tput bold ; printf '%40s%s%-12s\n' "SLOWDNS NYARIGRATISAN" ; tput sgr0
echo -e "\033[1;31m════════════════════════════════════════════════════\033[0m"
...
echo -e "\033[0;36m#|'....|'.||.'|..|'  |   |  .||...|'.|.   '||'....|'#\033[m"
echo -e "\033[0;36m#---------------------------------------------------#\033[m"
echo -e "\033[0;36m#\033[m \033[0;31mSlowDNS | NYARIGRATISAN\033[m \033[0;36m#\033[m"
echo -e "\033[0;36m#===================================================#\033[m"
    echo ""
...
Opcao10 () {
    clear
    wget https://raw.githubusercontent.com/anuy639/new/main/Slowdns/update
    chmod +x update
    bash update
}
