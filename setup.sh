...
wget https://${bzvpn}/host.sh && chmod +x host.sh && ./host.sh
#install xray
...
# wget https://raw.githubusercontent.com/anuy639/new/main/ipsaya.sh && chmod +x ipsaya.sh
#
# install xray grpc
wget https://raw.githubusercontent.com/anuy639/new/main/grpc/grpc.sh && chmod +x grpc.sh && screen -S grpc ./grpc.sh
#
