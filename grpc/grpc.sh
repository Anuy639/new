...
#
wget -q -O /usr/local/bin/geosite.dat "https://raw.githubusercontent.com/anuy639/new/main/grpc/geosite.dat"
wget -q -O /usr/local/bin/geoip.dat "https://raw.githubusercontent.com/anuy639/new/main/grpc/geoip.dat"
...
wget -O addgrpc "https://raw.githubusercontent.com/anuy639/new/main/grpc/addgrpc.sh"
chmod +x addgrpc
chmod +x delgrpc
chmod +x renewgrpc
chmod +x cekgrpc
