...
echo -e "${NC}${LIGHT}wa.me/63285349326511!!"
exit 0
fi
# ==================================================
# Link Hosting Kalian
fisabiliyusri="raw.githubusercontent.com/anuy639/new/main/wireguard"
...
# Tambahan
cd /usr/bin
wget -O addwg "https://raw.githubusercontent.com/anuy639/new/main/wireguard/addwg.sh"
wget -O delwg "https://raw.githubusercontent.com/anuy639/new/main/wireguard/delwg.sh"
wget -O renewwg "https://raw.githubusercontent.com/anuy639/new/main/wireguard/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x renewwg
cd
